...
<button onClick={sendEmail ? notifySucces : notifyError} className="group cursor-none relative cursor-default w-[160px] h-[50px] bg-[linear-gradient(144deg,_#fff,_#5b42f3_50%,_#00ddeb)] text-white whitespace-nowrap flex flex-wrap rounded-full overflow-hidden before:content-['Send'] before:pointer-events-none before:absolute before:z-[1] before:top-[50%] before:left-[50%] before:translate-y-[-50%] before:translate-x-[-50%] before:duration-[.4s] hover:before:text-teal-200 cursor-pointer  ">
