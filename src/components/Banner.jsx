...
const Banner = () => {
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          <div  className='flex-1 text-center font-secondary lg:text-left'>
            ...
            initial='hidden'
              ...
              <Link to='contact' className="group cursor-none relative cursor-default w-[140px] h-[50px] bg-[linear-gradient(144deg,_#fff,_#5b42f3_50%,_#00ddeb)] text-white whitespace-nowrap flex flex-wrap rounded-full overflow-hidden before:content-['Contact_me'] before:pointer-events-none before:absolute before:z-[1] before:top-[50%] before:left-[50%] before:translate-y-[-50%] before:translate-x-[-50%] before:duration-[.4s] hover:before:text-teal-200 cursor-pointer  ">
  ...
  <div className="w-[10px] h-[10px] blur-[5px] bg-[rgb(30,41,59)] delay-[0.2s] duration-[0.4s] hover:bg-transparent hover:delay-0 hover:duration-0 group-focus:bg-transparent group-focus:delay-[1.35s]"></div>
              ...
              <a href="https://t.me/alia_tulchii"  target='blank' className='w-[52px] h-[52px] z-50 rounded-full bg-[linear-gradient(144deg,_#fff,_#0232c4)] flex items-center justify-center content-center overflow-hidden duration-3 ease-in  hover:bg-[linear-gradient(144deg,_#fff,_#02e1ff)] hover:duration-3 hover:ease-out'>
                <FaTelegram className="w-7 h-7 hover:-translate-y-1 hover:scale-110  duration-300"/>
                </a>

                <a href="https://github.com/AliaTulchii"  target='blank' className='w-[52px] h-[52px] z-50 rounded-full bg-[linear-gradient(144deg,_#fff,_#0232c4)] flex items-center justify-center content-center overflow-hidden duration-3 ease-in  hover:bg-[linear-gradient(144deg,_#fff,_#7900eb)] hover:duration-3 hover:ease-out'>
                  <FaGithub className="w-7 h-7 hover:-translate-y-1 hover:scale-110  duration-300"/>
                </a>

                <a href="https://www.linkedin.com/in/halyna-tulchii-869569271/"  target='blank' className='w-[52px] h-[52px] z-50 rounded-full bg-[linear-gradient(144deg,_#fff,_#0232c4)] flex items-center justify-center content-center overflow-hidden duration-3 ease-in  hover:bg-[linear-gradient(144deg,_#aab3f4,_#081bae)] hover:duration-3 hover:ease-out'>
